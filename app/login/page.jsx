        ...
        <Card className="shadow-2xl border-0 bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg animate-in slide-in-from-bottom-8 duration-700 delay-300">
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2 animate-in slide-in-from-right-4 duration-500 delay-700">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:scale-110 transition-all duration-300"
                  >
              ...
              <div className="text-right animate-in slide-in-from-bottom-4 duration-500 delay-900">
                <Link
                  href="/forgot-password"
                  className="text-sm bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent hover:from-purple-600 hover:to-pink-600 dark:hover:from-purple-300 dark:hover:to-pink-300 hover:underline transition-all duration-300"
                >
            ...
            <div className="mt-6 text-center animate-in slide-in-from-bottom-4 duration-500 delay-1400">
